...
| 主体                                | 含义             | 示例                        | 存在条件           |
|-----------------------------------|----------------|---------------------------|----------------|
| \<platform>:g<group_id>:<user_id> | 群用户            | qq:g87654321:12345678     |                |
| onebot:g<group_id>:<user_id>      | 群用户            | onebot:g87654321:12345678 |                |
| \<platform>:<user_id>             | 用户             | qq:12345678               |                |
| onebot:<user_id>                  | 用户             | onebot:12345678           |                |
...
| \<platform>:<user_id>                           | 用户             | telegram:12345678                      |               |
| onebot:<user_id>                                | 用户             | onebot:12345678                        |               |
| superuser                                       | 超级用户           |                                        | 仅当该用户为超级用户时存在 |
