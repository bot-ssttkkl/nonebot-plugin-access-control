...
def upgrade(name: str = "") -> None:
    ...
    sa.PrimaryKeyConstraint('subject', 'service', name=op.f('pk_nonebot_plugin_access_control_permission'))
    )
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_nonebot_plugin_access_control_rate_limit_rule'))
    )
    with op.batch_alter_table('nonebot_plugin_access_control_rate_limit_rule', schema=None) as batch_op:
        batch_op.create_index('ix_ac_rate_limit_rule_subject_service', ['subject', 'service'], unique=False)
    ...
    sa.ForeignKeyConstraint(['rule_id'], ['nonebot_plugin_access_control_rate_limit_rule.id'], name=op.f('fk_nonebot_plugin_access_control_rate_limit_token_rule_id_nonebot_plugin_access_control_rate_limit_rule')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_nonebot_plugin_access_control_rate_limit_token'))
    )
    with op.batch_alter_table('nonebot_plugin_access_control_rate_limit_token', schema=None) as batch_op:
        batch_op.create_index('ix_ac_rate_limit_token_expire_time', ['expire_time'], unique=False)
        batch_op.create_index('ix_ac_rate_limit_token_rule_id', ['rule_id'], unique=False)
