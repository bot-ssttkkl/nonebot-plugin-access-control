...
async def _(permission: Permission):
    logger.debug(f"on set permission: {permission.service} {permission.subject}, now allow={permission.allow}")
...
async def _(permission: Permission):
    logger.debug(f"on change permission: {permission.service} {permission.subject}, now allow={permission.allow}")
